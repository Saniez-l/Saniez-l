...
*  **SGBD & Langages :** SQL, PostgreSQL

**Cybersécurité & Réseau (En cours d'acquisition)**
*  **Analyse :** Nmap, Wireshark, Modélisation des menaces, SIEM (bases)
*  **Concepts :** Sécurité Réseau, Modèle OSI, TCP/IP, Cryptographie, Gestion des risques, Sécurité des bases de données (Injections SQL)
...
###  Mes Forces (Soft Skills)

* **Adaptabilité & Rigueur :** Forgées par des années sur la route et sur les chantiers.
* **Résolution de problèmes :** Capacité à garder mon sang-froid et à trouver des solutions logiques.
* **Travail d'équipe :** Sens du collectif, communication claire et volonté d'apprendre au contact d'experts.
...
* **Portfolio / Projets :** Jetez un œil à mes dépôts ci-dessous ou consultez directement mon portfolio :[Mon portfolio](https://github.com/sarahwcqz/Portfolio)!
